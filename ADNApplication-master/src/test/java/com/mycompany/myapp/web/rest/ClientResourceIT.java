...
class ClientResourceIT {
    ...
    private static final String DEFAULT_UID_CLIENT = "AAAAAAAAAA";
    private static final String UPDATED_UID_CLIENT = "BBBBBBBBBB";

    private static final String DEFAULT_NAME_CLIENT = "AAAAAAAAAA";
    private static final String UPDATED_NAME_CLIENT = "BBBBBBBBBB";

    private static final String DEFAULT_PRODUCT_CLIENT = "AAAAAAAAAA";
    private static final String UPDATED_PRODUCT_CLIENT = "BBBBBBBBBB";
    ...
    private static final Statut DEFAULT_STATUT = Statut.SUSPENDED;
    private static final Statut UPDATED_STATUT = Statut.IN_TEST;
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            .uidClient(DEFAULT_UID_CLIENT)
            .nameClient(DEFAULT_NAME_CLIENT)
            .productClient(DEFAULT_PRODUCT_CLIENT)
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client()
            .uidClient(UPDATED_UID_CLIENT)
            .nameClient(UPDATED_NAME_CLIENT)
            .productClient(UPDATED_PRODUCT_CLIENT)
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getUidClient()).isEqualTo(DEFAULT_UID_CLIENT);
        assertThat(testClient.getNameClient()).isEqualTo(DEFAULT_NAME_CLIENT);
        assertThat(testClient.getProductClient()).isEqualTo(DEFAULT_PRODUCT_CLIENT);
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].uidClient").value(hasItem(DEFAULT_UID_CLIENT)))
            .andExpect(jsonPath("$.[*].nameClient").value(hasItem(DEFAULT_NAME_CLIENT)))
            .andExpect(jsonPath("$.[*].productClient").value(hasItem(DEFAULT_PRODUCT_CLIENT)))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.uidClient").value(DEFAULT_UID_CLIENT))
            .andExpect(jsonPath("$.nameClient").value(DEFAULT_NAME_CLIENT))
            .andExpect(jsonPath("$.productClient").value(DEFAULT_PRODUCT_CLIENT))
    ...
    void putNewClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getUidClient()).isEqualTo(UPDATED_UID_CLIENT);
        assertThat(testClient.getNameClient()).isEqualTo(UPDATED_NAME_CLIENT);
        assertThat(testClient.getProductClient()).isEqualTo(UPDATED_PRODUCT_CLIENT);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.uidClient(UPDATED_UID_CLIENT).nameClient(UPDATED_NAME_CLIENT).productClient(UPDATED_PRODUCT_CLIENT);
