...
describe('Client e2e test', () => {
  ...
  it('should load Clients', async () => {
    ...
    expect(await clientComponentsPage.getTitle()).to.eq('adnApplicationApp.client.home.title');
  ...
  it('should load create Client page', async () => {
    ...
    expect(await clientUpdatePage.getPageTitle()).to.eq('adnApplicationApp.client.home.createOrEditLabel');
  ...
  it('should create and save Clients', async () => {
    ...
    await promise.all([
      clientUpdatePage.setUidClientInput('uidClient'),
      clientUpdatePage.setNameClientInput('nameClient'),
      clientUpdatePage.setProductClientInput('productClient'),
      clientUpdatePage.setCommentInput('comment'),
      clientUpdatePage.setDescriptionInput('description'),
      clientUpdatePage.statutSelectLastOption(),
      clientUpdatePage.client_productSelectLastOption(),
      clientUpdatePage.versionApplicableSelectLastOption(),
      clientUpdatePage.versionCibleSelectLastOption(),
    ]);
  ...
  it('should delete last Client', async () => {
    ...
    expect(await clientDeleteDialog.getDialogTitle()).to.eq('adnApplicationApp.client.delete.question');
