...
//récupérer le nom d'un fichier et ajouter à les champs ***
    ...
    AddVersionApplicableADN(update:IUpdate):void{
        this.updateService.addVersionApplicabe(update).subscribe(ResVersionApplicableADN => {
    ...
    AddVersionApplicable(update:IUpdate):void{
        this.updateService.createVersionApplicable(update,this.todayString,this.ResVersionApplicableADN.uid,this.ResVersionApplicableADN.createdBy).subscribe(ResAddVersionApplicable => {
    ...
    AddVersionCibleADN(update:IUpdate):void{
        this.updateService.addVersionCible(update).subscribe(ResAddVersionCibleADN=> {
    ...
    AddVersionCible(update:IUpdate):void{
        this.updateService.createVersionCible(update,this.todayString,this.ResAddVersionCibleADN.uid,this.ResAddVersionCibleADN.createdBy).subscribe(ResAddVesionCible => {
    ...
    UpdateADN(update:IUpdate):void{
        this.updateService.createUpdateADN(update,this.ResVersionApplicableADN.uid,this.ResAddVersionCibleADN.uid).subscribe(resUpdateADN => {
    ...
    RegisterUpload(update:IUpdate):void{
        this.updateService.registerUpload(this.fileName.size.toString(),this.resUpdateADN.uid,this.contentfile,this.fileName.name)
            .subscribe(ResRegisterUpload => {
    ...
    createUpdate(update:IUpdate):void{
        this.updateService.createUpdate(update,this.resUpdateADN.uid, this.ResAddVersionApplicable.id, this.ResAddVesionCible.id,this.ResVersionApplicableADN.uid,this.ResAddVersionCibleADN.uid,this.todayString)
            .subscribe(ResUpdate => {
