...
describe('ClientUpdate Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'client-update', component: ClientUpdateComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.clientUpdates?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
