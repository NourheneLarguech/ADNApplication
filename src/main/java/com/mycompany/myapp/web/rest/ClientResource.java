...
public class ClientResource {
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                if (client.getUidClient() != null) {
                    existingClient.setUidClient(client.getUidClient());
                }
                if (client.getNameClient() != null) {
                    existingClient.setNameClient(client.getNameClient());
                }
                if (client.getProductClient() != null) {
                    existingClient.setProductClient(client.getProductClient());
                }
    ...
    public ResponseEntity<List<Client>> getAllClients(
        ...
        Page<Client> page;
        if (eagerload) {
            page = clientRepository.findAllWithEagerRelationships(pageable);
        } else {
